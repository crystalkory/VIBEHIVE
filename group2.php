    ...
    ?>
        <div class="post" data-post-id="<?= $post['id'] ?>">
            ...
            <div class="post-actions">
                ...
                <button class="action-btn comment-btn" onclick="location.href='comment.php?post_id=<?= $post['id'] ?>'">
        ...
        ?>
            ...
            <div class="post boosted-post" data-post-id="<?= $boostPost['id'] ?>">
                ...
                <div class="post-actions">
                    ...
                    <button class="action-btn comment-btn" onclick="location.href='comment.php?post_id=<?= $boostPost['id'] ?>'">
                        <span class="icon">💬</span>
