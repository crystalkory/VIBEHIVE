...
class TikTokAdvancedAlgorithm {
    ...
    // NEW: Enhanced preference-based scoring
...
foreach ($allPosts as $post) {
    ...
    // NEW: Enhanced user preference scoring
    ...
    // 1. ENHANCED USER PREFERENCE SCORING (25% weight)
    $preferenceScore = $userPreferenceScore * 25 / 100;
    $score += $preferenceScore;
    
    // 2. ENHANCED REAL-TIME ENGAGEMENT METRICS (25% weight)
    $engagementScore = (
    ...
    // 5. TIME DECAY WITH USER PATTERNS (10% weight)
    ...
    // 6. ENHANCED DIVERSITY & DISCOVERY (5% weight)
    $diversityScore = 0;
    ...
    $post['user_preference_score'] = round($userPreferenceScore, 2); // NEW
        ...
        <?php foreach ($posts as $post): ?>
            <div class="reel" data-post-id="<?= $post['id'] ?>">
                ...
                <div class="score-breakdown">
                    ...
                    <div class="score-bar"><div class="score-fill" style="width: <?= ($post['score_breakdown']['engagement'] / 25) * 100 ?>%"></div></div>
                    ...
                    <div class="score-bar"><div class="score-fill" style="width: <?= ($post['score_breakdown']['diversity'] / 5) * 100 ?>%"></div></div>
