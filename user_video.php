...
// Helper functions for counts and user-like check
...
// Fetch all video posts for logged in user
$stmt = $pdo->prepare("
    SELECT p.*, u.username, u.profile_pic_url
    FROM posts p
    JOIN users u ON p.user_id = u.id
    WHERE p.user_id = :user_id AND p.post_type = 'video'
...
<?php if (empty($posts)): ?>
  <p>You have not made any video posts yet.</p>
<?php else: ?>
