...
// Initialize all result variables to prevent undefined variable errors
$allResults = [];
$hashtagResults = [];
$userResults = [];
$hashtagList = [];
$results = []; // Initialize $results here to fix the error
$totalVideos = 0;
$totalUsers = 0;
$totalHashtags = 0;
$totalPagesVideos = 1;
...
$totalResults = count($allResults) + count($userResults) + count($hashtagList);
...
// Handle AJAX requests for like/unlike
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // ========== AJAX HANDLERS FOR COMMENTS (FROM PEOPLE.PHP) ==========
